...
// import { ArrowLeft, CheckCircle2, Timer } from "lucide-react"; // Installed icons for a professional look
...
//     const [isSent, setIsSent] = useState(false); // Controls form visibility
...
//             if (res.status === 200) {
//                 setIsSent(true); // Hides the form and displays the success card
//                 toast({
...
//             {/* Conditionally Render Form OR Success Card */}
//             {!isSent ? (
...
//                         This verification link expires quickly.
//                     </div>

//                     {/* Countdown indicator */}
//                     <div className="text-xs text-gray-400 mb-4">
//                         Redirecting to login in <span className="font-semibold text-gray-600">{formatTime(timeLeft)}</span>
//                     </div>

//                     {/* Immediate redirection anchor */}
