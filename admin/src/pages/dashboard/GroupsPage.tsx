...
useEffect(() => {
  ...
  useEffect(()=>{
      socket.on("messageAdminRefresh", ({newMessage, groupId}) => {
        console.log(newMessage, selectedGroup);
  ...
  const handleGetGroups = async () => {
    ...
    if (res.status === 200) setGroupList(res.data.groups);
  };
                ...
                <div className="relative">
                  ...
                  {openMenuId === group._id && (
                    <div className="absolute right-0 top-6 bg-white border shadow-lg rounded-md w-32 z-50">
                      <button className="w-full px-3 py-2 text-sm hover:bg-gray-100">
                        Edit
                      </button>
